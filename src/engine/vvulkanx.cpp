...
// Base functions that we are gonna move to vvulkan proper
...
void VPushBackSetElement(SPX_GraphicsShaderObject::DescSetEntry* set,VkDescriptorType type,u32 bind,u32 array_count){
...
SPX_GraphicsShaderObject::DescSetEntry* VGetSet(SPX_GraphicsShaderObject* obj,u32 set_no){
...
void VPushBackDescSet(SPX_GraphicsShaderObject* obj,u32 set_no,u32 shader_stage){
    
    SPX_GraphicsShaderObject::DescSetEntry* set = VGetSet(obj,set_no);
...
void VPushBackPushConstRange(SPX_GraphicsShaderObject* _restrict obj,VkFormat* format_array,u32 format_count,u32 size,VkShaderStageFlagBits shader_stage){
...
void VSetInputAssemblyState(GraphicsPipelineSpecObject* spec,VkPrimitiveTopology topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST,VkBool32 restart = false){
...
void VSetRasterState(GraphicsPipelineSpecObject* spec,VkCullModeFlags cullmode = VK_CULL_MODE_BACK_BIT,VkFrontFace frontface = VK_FRONT_FACE_CLOCKWISE,VkBool32 enable_depthclamp = false,VkPolygonMode polymode = VK_POLYGON_MODE_FILL,VkBool32 enable_depthbias = false,f32 depthbias_const = 0.0f,f32 depthbias_clamp = 0.0f,f32 depthbias_slope = 0.0f,f32 linewidth = 1.0f,VkBool32 enable_discard = false){
...
// Extended functions - We can technically use these as the base functions

void VDescPushBackPoolSpec(VDescriptorPoolSpec* spec,SPX_GraphicsShaderObject* obj,u32 descset_count,u32 desc_set){
...
VkPipelineLayout VCreatePipelineLayout(const  VDeviceContext* _restrict vdevice,VkDescriptorSetLayout* descriptorset_array,u32 descriptorset_count,SPX_GraphicsShaderObject* obj){
...
void _ainline SetAddElement(SPX_GraphicsShaderObject::DescSetEntry* set,DescEntry* entry){
